...
public class AmigoMeleeAttackGoal<T extends Mob & RangedAttackMob> extends Goal {
    ...
    public AmigoMeleeAttackGoal(AmigoEntity amigo, double speedModifier) {
        this.amigo = amigo;
    ...
    public void tick() {
        ...
        if (target != null) {
            ...
            AABB attackRange = this.amigo.getBoundingBox().inflate(2.0);
