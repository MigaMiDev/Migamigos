...
public class CompanionMeleeAttackGoal extends Goal {
    ...
    public CompanionMeleeAttackGoal(PathfinderMob pMob, double pSpeedModifier, boolean pFollowingTargetEvenIfNotSeen) {
        this.mob = pMob;
    ...
    public void stop() {
        ...
        ((Companion) this.mob).setAttacking(false);
    }
