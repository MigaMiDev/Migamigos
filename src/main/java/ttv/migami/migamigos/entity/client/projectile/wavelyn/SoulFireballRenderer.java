package ttv.migami.migamigos.entity.client.projectile.wavelyn;
...
@OnlyIn(Dist.CLIENT)
public class SoulFireballRenderer extends EntityRenderer<SoulFireball> {
   private static final ResourceLocation TEXTURE_LOCATION = new ResourceLocation(Reference.MOD_ID, "textures/projectile/wavelyn/soul_fireball.png");
   private static final RenderType RENDER_TYPE = RenderType.entityCutoutNoCull(TEXTURE_LOCATION);

   public SoulFireballRenderer(EntityRendererProvider.Context pContext) {
      super(pContext);
   }

   protected int getBlockLightLevel(SoulFireball pEntity, BlockPos pPos) {
      return 15;
   }

   public void render(SoulFireball pEntity, float pEntityYaw, float pPartialTicks, PoseStack pPoseStack, MultiBufferSource pBuffer, int pPackedLight) {
      pPoseStack.pushPose();
    ...
    */
   public ResourceLocation getTextureLocation(SoulFireball pEntity) {
